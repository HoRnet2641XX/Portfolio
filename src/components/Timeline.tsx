    ...
    >
      <div ref={ref} className="w-full max-w-content">
        ...
        <div className="relative">
          {/* Vertical trace — dashed via background */}
          <div
            className="absolute left-[15px] md:left-[19px] top-[8px] bottom-[8px] w-[2px]"
            style={{
              backgroundImage:
                'linear-gradient(to bottom, rgba(255,140,50,0.45) 50%, transparent 50%)',
          ...
          <ol className="space-y-[32px] md:space-y-[44px] list-none m-0 p-0">
            {timeline.map((entry, i) => (
              <motion.li
                ...
                transition={{ duration: 0.45, delay: i * 0.15, ease: [0.33, 1, 0.68, 1] }}
                className="relative pl-[44px] md:pl-[56px]"
              >
                {/* Node — diamond shape for variety */}
                <div
